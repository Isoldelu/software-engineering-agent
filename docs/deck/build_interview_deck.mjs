...
function buildCover(presentation) {
  ...
  addText(slide, "155", { left: 68, top: 548, width: 116, height: 52 }, { fontSize: 40, bold: true, color: C.teal });
  ...
  setNotes(
    ...
    [
      ...
      "Current CI evidence: https://github.com/Isoldelu/software-engineering-agent/actions/runs/33363220127",
    ],
  );
}
...
function buildClose(presentation) {
  ...
  addText(slide, "155", { left: 56, top: 214, width: 150, height: 62 }, { fontSize: 52, bold: true, color: C.teal });
  ...
  addText(slide, "16+14", { left: 56, top: 452, width: 180, height: 52 }, { fontSize: 42, bold: true, color: C.green });
  addText(slide, "bridge gates", { left: 56, top: 508, width: 180, height: 28 }, { fontSize: 18, color: C.muted });
  ...
  addText(slide, "Run 33363220127", { left: 878, top: 330, width: 300, height: 34 }, { fontSize: 23, bold: true, typeface: MONO });
  ...
  setNotes(
    ...
    [
      "GitHub Actions Run: https://github.com/Isoldelu/software-engineering-agent/actions/runs/33363220127",
      "Step 34 evidence: evaluation/step34_bridge_fault_report.md",
