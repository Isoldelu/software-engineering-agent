...
function buildCover(presentation) {
  ...
  addText(slide, "134", { left: 68, top: 548, width: 116, height: 52 }, { fontSize: 40, bold: true, color: C.teal });
  ...
  setNotes(
    ...
    [
      ...
      "Current CI evidence: https://github.com/Isoldelu/software-engineering-agent/actions/runs/33311037079",
    ],
  );
}
...
function buildClose(presentation) {
  ...
  addText(slide, "134", { left: 56, top: 214, width: 150, height: 62 }, { fontSize: 52, bold: true, color: C.teal });
  ...
  addText(slide, "Run 33311037079", { left: 878, top: 330, width: 300, height: 34 }, { fontSize: 23, bold: true, typeface: MONO });
  ...
  setNotes(
    ...
    [
      "GitHub Actions Run: https://github.com/Isoldelu/software-engineering-agent/actions/runs/33311037079",
